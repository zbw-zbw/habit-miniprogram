...
Page({
    ...
    loadHabits() {
        ...
        api_1.habitAPI.getHabits()
            ...
            // 获取每个习惯的统计数据
            const statsPromises = habits.map(habit => api_1.habitAPI.getHabitStats(habit.id || habit._id || '')
                .catch(error => {
    ...
    debug() {
        ...
        habits.forEach(habit => {
            ...
            console.log(`- 中文分类: ${this.data.categoryMap[habit.category] || habit.category}`);
