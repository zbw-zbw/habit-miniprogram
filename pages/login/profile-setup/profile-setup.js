    ...
    submitUserInfo() {
        ...
        uploadAvatarPromise
                ...
                wx.request({
                    ...
                    success: (res) => {
                        ...
                        if (res.statusCode === 200 && res.data && res.data.success) {
                            ...
                            reject(new Error(((_a = res.data) === null || _a === void 0 ? void 0 : _a.message) || '登录失败'));
                        }
                    },
                    fail: (err) => {
                        reject(err);
            ...
            setTimeout(() => {
                ...
                // 如果是从登录页面进入的，返回两级
                if (pages.length > 2 && ((_a = pages[pages.length - 2].route) === null || _a === void 0 ? void 0 : _a.includes('login'))) {
