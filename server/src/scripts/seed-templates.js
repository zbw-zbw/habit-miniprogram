...
const templates = [
  // 健康类
  {
    ...
    scientificBasis:
      '研究表明，充足的水分摄入有助于维持身体正常功能，提高新陈代谢，改善皮肤状态，并有助于排出体内毒素。',
    expectedOutcomes: [
      '提高精力水平',
      '改善皮肤质量',
      '促进新陈代谢',
    ...
    faqs: [
      {
        question: '一天应该喝多少水？',
        answer:
          '一般建议成年人每天喝约2升水，相当于8杯250ml的水。但具体需求因个人体质、活动量和气候而异。',
      },
      {
        question: '什么时候喝水最好？',
  ...
  },
  {
    ...
    scientificBasis:
      '早晨锻炼可以增强新陈代谢，提高一天的精力水平，并促进内啡肽的释放，改善情绪和认知功能。',
    expectedOutcomes: [
      '提高全天能量水平',
      '改善心情和注意力',
      '加强身体素质',
  ...
  // 学习类
  {
    ...
    scientificBasis:
      '定期阅读可以增强认知能力，提高语言表达能力，扩大知识面，并有助于减轻压力和预防认知衰退。',
    expectedOutcomes: [
      '提高专注力和理解力',
      '扩展知识面',
      '减轻压力',
  ...
  // 工作类
  {
    ...
    scientificBasis:
      '番茄工作法通过时间分块和定期休息，利用了人脑注意力集中的自然周期，提高工作效率和持久性。',
    expectedOutcomes: [
      '提高工作专注度',
      '减少拖延行为',
      '提高工作效率',
  ...
  // 社交类
  {
    ...
    scientificBasis:
      '心理学研究表明，记录感恩事项可以提高幸福感，减轻抑郁症状，改善睡眠质量，并促进更积极的人际关系。',
    expectedOutcomes: [
      '提高幸福感和满足感',
      '减少负面情绪',
      '改善人际关系',
  ...
  // 财务类
  {
    ...
    scientificBasis:
      '定期记账和财务追踪是财务健康的基础，可以帮助了解消费模式，控制支出，培养储蓄习惯，实现财务目标。',
    expectedOutcomes: [
      '清晰了解个人财务状况',
      '识别不必要的支出',
      '培养储蓄意识',
