    ...
    const groups = [
      {
        name: '每日阅读打卡',
        description:
          '坚持每天阅读30分钟，分享阅读心得和好书推荐。一起在书海中遨游，提升自己的知识储备和思考能力。',
        type: 'habit',
        isPrivate: false,
        tags: ['阅读', '学习', '自我提升'],
      ...
      },
      {
        name: '健身达人',
        description:
          '分享健身经验、运动计划和健康饮食。无论你是健身新手还是老手，都可以在这里找到志同道合的伙伴，互相鼓励，共同进步。',
        type: 'habit',
        isPrivate: false,
        tags: ['健身', '运动', '健康'],
      ...
      },
      {
        name: '早起俱乐部',
        description:
          '每天早起，享受清晨的宁静与美好。分享早起技巧、晨间习惯和高效工作方法。一起培养健康的作息习惯，提高生活质量。',
        type: 'habit',
        isPrivate: false,
        tags: ['早起', '时间管理', '生活'],
      ...
      },
      {
        name: '编程学习小组',
        description:
          '分享编程学习资源、经验和项目。无论你是编程新手还是老手，都可以在这里找到志同道合的伙伴，一起学习成长。',
        type: 'habit',
        isPrivate: false,
        tags: ['编程', '学习', '技术'],
      ...
      },
      {
        name: '冥想与正念',
        description:
          '分享冥想技巧、正念练习和心灵成长。在繁忙的生活中找到内心的平静，提高专注力和幸福感。',
        type: 'habit',
        isPrivate: false,
        tags: ['冥想', '正念', '心理健康'],
